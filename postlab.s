	...
	MOVF    UNIDADES, W	    ; Colocamos el valor de NIBBLES (posición 0) en W
	CALL    TABLA		    ; Transformamos el valor a enviar a display
	MOVWF   DISPLAY2	    ; Guardamos en variable DISPLAY2
	
	MOVF    DECENAS, W	    ; Colocamos el valor de NIBBLES (posición 1 en W
	CALL    TABLA		    ; Transformamos el valor a enviar a display
	MOVWF   DISPLAY2+1	    ; Guardamos en variable DISPLAY2+1
	
	MOVF    CENTENAS, W	    ; Colocamos el valor de NIBBLES (posición 2) en W
	CALL    TABLA		    ; Transformamos el valor a enviar a display
	...
	; Lógica de condicionales para verificar que display encender cada 5 ms
	...
	INCF	CENTENAS
	BTFSC	STATUS, 0	    ; Verificar si ocurrió BORROW
	GOTO	$-4
	DECF	CENTENAS
	...
	RESET_TIMER 240		; Reiniciamos la bandera interrupción
	return
